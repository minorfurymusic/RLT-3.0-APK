...
import { ExamRecord, ConsultationRecord, MedicalCertificate, BiomarkerResult } from "../types";
...
export async function extractCertificateData(fileData: string, mimeType: string): Promise<Partial<MedicalCertificate>> {
  const model = "gemini-3-flash-preview";
